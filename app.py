...
def recommend_music(face=False):
    if face:
...
tk.Button(button_frame, text="Use Face Detection", command=lambda: recommend_music(face=True), width=16).grid(row=0, column=2, padx=6)
